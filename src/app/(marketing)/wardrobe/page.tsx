...
// Lightweight variant of the /kitchen page for the wardrobe product line.
// Doesn't yet reuse the full Kitchen client component because that one
// carries kitchen-specific copy and heavy filter UX. When wardrobe SKUs
// grow past a couple of dozen we can extract Kitchen into a generic
// ProductLineListing and share it — for now a clean grid ships fast
// and gets the routing correct.
        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-end pb-10 sm:pb-14 lg:pb-16">
          <div className="flex flex-col gap-3 sm:gap-4 max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-white/80 max-w-lg leading-relaxed">
              Hangers, pull-outs, trouser racks, and fittings engineered for
              modern Indian wardrobes.
            </p>
        ...
        {products.length === 0 ? (
          <div className="border border-[#D4D4D4] dark:border-[#2A2A2A] rounded-sm p-12 text-center">
            <p className="text-[#0A0A0A] dark:text-[#F5F5F5] font-semibold">
              Wardrobe range coming soon.
            </p>
            <p className="text-sm text-[#6B6B6B] dark:text-[#9A9A9A] mt-3 max-w-md mx-auto">
              We&apos;re adding wardrobe accessories to the catalogue. In the
