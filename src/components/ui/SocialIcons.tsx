...
// Reusable colored brand icon components — each uses its platform's official color.
// lucide-react does not include brand icons, so these are self-contained SVGs.
